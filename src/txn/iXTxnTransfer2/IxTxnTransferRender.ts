...
const genPageHome = () => {
  ...
  page.innerHTML = `
    <div class="grid-container">
        ...
        <div class='grid-item'>
          <ix-combo data-id="payer" data-target="ix-txn-transfer2.payer" data-action="ichange:ix-txn-transfer2#doPayerChanged"></ix-combo></div>
    
        <div class='grid-item'>轉入帳號:</div>
        <div class='grid-item'>
          <ix-combo data-id="payee" data-target="ix-txn-transfer2.payee" data-action="ichange:ix-txn-transfer#modelUpdate2"></ix-combo></div>
    ...
    <input type="button" value="下一步" data-action="click:ix-txn-transfer2#doActionHome"></input>
...
const genPageConfirm = (data : any) => {
  ...
  page.innerHTML = `
    ...
    <input type="button" value="確認" data-action="click:ix-txn-transfer2#doActionConfirm"></input>
    <pre class="message" hidden="true" data-target="ix-txn-transfer2.submitDesc"></pre>
  `
  return page;
}
...
const genPageResult = (data : any) => {
  ...
  page.innerHTML = `
    ...
    <input type="button" value="再做一筆" data-action="click:ix-txn-transfer2#doActionRenew"></input>
    <pre class="message" hidden="true" data-target="ix-txn-transfer2.submitDesc"></pre>
  `
  return page;
}
